...
function createArticleElement(article) {
    ...
    articleEl.setAttribute('aria-labelledby', `book-title-${article.id}`);
    ...
    articleEl.innerHTML = `
        <div class="review-grid">
            <div class="review-details">
                ...
                <div class="rating" aria-label="Rated ${article.stars.length} out of 5 stars">${article.stars}</div>
            </div>
...
function loadArticles() {
    ...
    // Loop through reviews and append each
